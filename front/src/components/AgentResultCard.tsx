...
const STATUS_META: Record<AgentResultStatus, { label: string; bg: string; fg: string; border: string; icon: string }> = {
  completed: { label: 'Completed', bg: '#ecfdf3', fg: '#05603a', border: '#a6f4c5', icon: '✓' },
  partial_completed: { label: 'Partial', bg: '#fffaeb', fg: '#b54708', border: '#fec84b', icon: '◐' },
  failed: { label: 'Failed', bg: '#fef3f2', fg: '#912018', border: '#fecdca', icon: '✗' },
